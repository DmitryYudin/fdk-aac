...
#define FFMPEG_CONFIGURATION "--target-os=win64 --arch=x86_64 --toolchain=msvc --disable-asm --enable-gpl --enable-version3 --enable-nonfree --enable-static --disable-shared --enable-small --disable-runtime-cpudetect --disable-autodetect --disable-ffplay --disable-ffprobe --disable-ffmpeg --disable-doc --disable-all --disable-everything --enable-avcodec --enable-avformat --disable-random --enable-muxer=latm --enable-muxer=mp4 --enable-muxer=mov --enable-muxer=null --enable-muxer=sbc --enable-demuxer=aac --enable-demuxer=loas --enable-demuxer=mov --enable-demuxer=mpegts --enable-demuxer=mpegtsraw --enable-protocol=file --enable-protocol=data --enable-parser=aac --enable-parser=aac_latm --enable-parser=mpegaudio --enable-bsf=aac_adtstoasc --enable-bsf=null"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2019
#define FFMPEG_DATADIR "/usr/local/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/share/ffmpeg"
#define CC_IDENT "Microsoft (R) C/C++ Optimizing Compiler Version 19.21.27702.2 for x64"
